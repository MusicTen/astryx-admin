 ...
 * Generated: 2026-07-13T12:43:58.521Z
 */

/**
 * astryx-admin theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { astryxAdminTheme } from './astryx-admin';
 *   import './astryx-admin.css';
 */
export const astryxAdminTheme = {
  name: 'astryx-admin',
  __built: true,
  tokens: {
    ...
    "--color-background-body": "light-dark(#f0f8ff, #1b1b1b)",
